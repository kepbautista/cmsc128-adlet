	...
	<ul>
		<?php
			if(isset($_GET['scatternotsuccess']))
				echo "<li>Scatter Plot can't be produced. (Insufficient information about GWA or UPG.)</li>";
			if(isset($_GET['barnotsuccess']))
				echo "<li>Bar Graph can't be produced. (Insufficient information about GWA or UPG.)</li>";
