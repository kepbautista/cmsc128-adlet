			...
			<ul>
				<?php
					if(isset($_GET['scatternotsuccess']))
						echo "<li class='fieldError'>Scatter Plot can't be produced. (Insufficient information about GWA)
							 <br/>One or more students has no GWA available.</li>";
					if(isset($_GET['barnotsuccess']))
						echo "<li class='fieldError'>Bar Graph can't be produced. (Insufficient information about GWA)
							 <br/>One or more students has no GWA available.</li>";
					if(isset($_GET['stdno1']))
						echo "<li class='fieldError'>No grades available for Student 1.</li>";
					if(isset($_GET['stdno2']))
						echo "<li class='fieldError'>No grades available for Student 2.</li>";
					if(isset($_SESSION['isnull']))
						echo "<li class='fieldError'>No field should be null.</li>";
					if(isset($_SESSION['wrongstdno1']))
						echo "<li class='fieldError'>Wrong student number format for Student 1.</li>";
					if(isset($_SESSION['wrongstdno2']))
						echo "<li class='fieldError'>Wrong student number format for Student 2.</li>";
					if(isset($_SESSION['wronglength']))
						echo "<li class='fieldError'>Wrong student number length.</li>";
				?>
			</ul>
